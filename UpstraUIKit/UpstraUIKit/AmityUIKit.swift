...
public final class AmityUIKitManager {
    ...
    public static func setup(apiKey: String, httpUrl: String? = nil, socketUrl: String? = nil, cameraPermissionDeniedText: String, imagesPermissionDeniedText: String, settingsString: String, cancelString: String, loadingTitle: String, startTrackingFeedLoading: @escaping (()->()), stopTrackingFeedLoading: @escaping (()->())) {
        if let httpUrl = httpUrl, let socketUrl = socketUrl {
            AmityUIKitManagerInternal.shared.setup(apiKey, httpUrl: httpUrl, socketUrl: socketUrl, cameraPermissionDeniedText: cameraPermissionDeniedText, imagesPermissionDeniedText: imagesPermissionDeniedText, settingsString: settingsString, cancelString: cancelString, loadingTitle: loadingTitle, startTrackingFeedLoading: startTrackingFeedLoading, stopTrackingFeedLoading: stopTrackingFeedLoading)
